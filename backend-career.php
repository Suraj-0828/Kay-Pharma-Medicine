...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $transport = (new Swift_SmtpTransport('mail.kaypharma.co.in', 465, 'ssl'))  // 465 is a port number okay
        ->setUsername('noreply@kaypharma.co.in')          // c-penal : id or password
    ...
    $message = (new Swift_Message())
        ...
        ->setTo(['aniket.itarsia@gmail.com' => 'career Form Enquiry'])      // Your email id 
        ->setBody($data)
